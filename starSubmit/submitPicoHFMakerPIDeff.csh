...
#      .sl73_gcc485 //new compiler since 2018
...
# -- set root macro
set rootMacro=runPicoDpmAnaMakerPIDeff.C
...
# -- set memory limits in MB to get to the right queue
#set minMemory=100
#set maxMemory=399
...
#echo '<\!ENTITY minMem "'${minMemory}'">'                   >> $hackTemplate
#echo '<\!ENTITY maxMem "'${maxMemory}'">'                   >> $hackTemplate
