...
starver SL17d
root -q -b -l compileRunMacroLocallyDCA.C

path=`pwd -P`
path=$( echo $path | sed 's|//|/|g' )

echo executing submitPicoHFMakerTrackEffErr.csh f0r picoList_submit.list inside $path

csh starSubmit/submitPicoHFMakerTrackEffErr.csh $path ./picoLists/picoList_physics.list
