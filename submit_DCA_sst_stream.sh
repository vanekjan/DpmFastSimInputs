...
echo executing submitPicoHFMakerDCA.csh f0r picoList_submit_sst.list inside $path

csh starSubmit/submitPicoHFMakerDCA.csh $path ./picoLists/picoList_sst.list
