...
void runPicoDpmAnaMakerTrackEff(const Char_t *inputFile="test.list", const Char_t *outputFile="outputBaseName",
  ...
  hfCuts->setHFTinputsOrPIDefficiency(3); //0 - HFT inputs; 1 - PID efficiency pi; 2 - PID efficiency K; 3 - tracking efficiency sys. err.
  ...
  hfCuts->setCutPtRangeQA(0.3, 4.0); //pT range for tracking eff. error
