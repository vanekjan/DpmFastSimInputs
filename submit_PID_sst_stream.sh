...
sed -n '1,500 p' ./picoLists/picoList_all_new_sst_stream.list > picoList_submit_sst_PID.list
...
echo executing submitPicoHFMakerPIDeff.csh f0r picoList_submit_sst_PID.list inside $path

csh starSubmit/submitPicoHFMakerPIDeff.csh $path picoList_submit_sst_PID.list
